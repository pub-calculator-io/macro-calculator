...
Version: 1.0.0
Author: Macro Calculator / www.calculator.io
...
function display_calcio_ci_macro_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_macro_calculator', 'display_calcio_ci_macro_calculator' );